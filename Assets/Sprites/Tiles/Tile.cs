...
{
    public enum TileType { Grass, Mountain }
    public TileType tileType; // Property to hold the type of the tile

    [SerializeField] protected SpriteRenderer _renderer;
    [SerializeField] private GameObject _highlight;
    [SerializeField] private bool isWalkable;
    [SerializeField] public Hero hero; // Reference to the hero character
    [SerializeField] public List<EnemyHealth> enemies; // List of references to the enemy characters
